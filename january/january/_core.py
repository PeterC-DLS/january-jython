...
import org.eclipse.january.jython.PythonUtils as _pyutils

_cvt2j = _pyutils.convertToJava
_getslice = _pyutils.getSlice
_setslice = _pyutils.setSlice
_cvt2js = _pyutils.convertToSlice
_create = _pyutils.createFromObject
_createRange = _pyutils.createRange
...
#        super(lazyarray, self).__setattr__('attrs', _ldict(attrs, lock=True))
        super(lazyarray, self).__setattr__('attrs', _ldict(attrs))
        self.__data = dataset
